...
export function parseKoAmount(str) {
    if (!str) return 0;
...
export function formatKoAmount(val) {
    if (val === 0) return "0원";
...
export function formatDisplayAmount(str) {
    if (!str) return str;
...
export function calculateHierarchicalSummary(results) {
...
export function findDetails(itemName) {
...
export function extractRawCoverages(text) {
